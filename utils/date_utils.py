...
def date_to_mjd2000(year,month,day):
    """
    ...
    jd = B + C + D + day + 1720994.5 -int(2.4e6) - 51544
...
def datetime_to_mjd2000(date):
    ...
    return date_to_mjd2000(date.year,date.month,days)
    
    
def mjd2000_to_datetime(jd):
    """
    Convert a Julian Day to an `jdutil.datetime` object.
    ...
    """
    year, month, day = mjd2000_to_date(jd)
